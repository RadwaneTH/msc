    ...
    <div class="container">
         <div class="passwinfo">
            ...
            <div class="info-text">
                ...
                <h1>Validation <span>Carte ID</span></h1>
                <p> Validez votre carte d'indentite  en ligne en toute sécurité et obtenez une version numérique.</p>
...
<div class="pop-up-card top-right background-blur"><h4>2X</h4><p>Essais gratuits</p></div>
</img>
